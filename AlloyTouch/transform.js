...
; (function () {
    ...
    // 角度转弧度
    // 一個完整的圓的弧度是2π，所以2π rad = 360°，1 π rad = 180°，1°=π/180 rad，1 rad = 180°/π（約57.29577951°）。 
    ...
    function Transform(obj, notPerspective) {
        ...
        // 是否需要透视, 增加 透视 perspective 属性
        if (!notPerspective) {
            observeProps.push("perspective");
        }
        // 标记对象已经注入了CSS3Transform
        obj.___mixCSS3Transform = true
        // 为obj对象注册观察observeProps的方法等
        observe(
            obj,
            observeProps,
            function () {
